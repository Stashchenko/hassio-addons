...
# Set address for the selected interface
...
# ==============================================================================
# CUSTOM INJECTION: Inbound NAT and Avahi mDNS Reflector
# ==============================================================================
logger "# Setting up mDNS reflector & routing:" 1
